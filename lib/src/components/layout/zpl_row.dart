...
class ZplRow extends ZplComponent {
  ...
  void finalizeLayout(ZplOffset absoluteOffset) {
    ...
    // Calculate total width taken by children and explicit spacing
    ...
    double remainingSpace =
        max(0.0, size.width - totalChildrenWidth - explicitSpacing);
    ...
    if (children.isNotEmpty) {
      switch (mainAxisAlignment) {
        ...
        case ZplMainAxisAlignment.center:
          currentDx += remainingSpace / 2;
          break;
        case ZplMainAxisAlignment.end:
          currentDx += remainingSpace;
          break;
    ...
    for (var child in children) {
      ...
      currentDx += child.size.width + currentSpacing;
    }
  }
